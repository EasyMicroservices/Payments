...
namespace EasyMicroservices.Payments.VirtualServerForTests.TestResources
{
    ...
    {
        public static Dictionary<string, string> GetResources(string successUrl, string portalUrl = "https://checkout.stripe.com/c/pay/cs_test_a18Gcz1SnWVaj1eS8Wwf6N5owa0yTjYBgzaOYktduourJU2YALIhN1TMEb#fidkdWxOYHwnPyd1blpxYHZxWjA0S3dwR2lBTjI3YlVgcmBRVkl2Q25NN2hkYFJRMjVybzJJN0NWaGNQaGNha09Ka3RBak9cMmxzST1fdm9xaVFcbmhSf1JLYEc9bHdtNzRWZ3JmUHNGPHBpNTVxTmdCQTBSUScpJ2N3amhWYHdzYHcnP3F3cGApJ2lkfGpwcVF8dWAnPyd2bGtiaWBabHFgaCcpJ2BrZGdpYFVpZGZgbWppYWB3dic%2FcXdwYHgl")
        {
...
Content-Length: 0
            ...
            {{""id"":""cs_test_a18Gcz1SnWVaj1eS8Wwf6N5owa0yTjYBgzaOYktduourJU2YALIhN1TMEb"",""object"":""checkout.session"",""after_expiration"":null,""allow_promotion_codes"":null,""amount_subtotal"":1000,""amount_total"":1000,""automatic_tax"":{{""enabled"":false,""status"":null}},""billing_address_collection"":null,""cancel_url"":null,""client_reference_id"":null,""consent"":null,""consent_collection"":null,""created"":1696341772,""currency"":""usd"",""currency_conversion"":null,""custom_fields"":[],""custom_text"":{{""shipping_address"":null,""submit"":null,""terms_of_service_acceptance"":null}},""customer"":null,""customer_creation"":""if_required"",""customer_details"":null,""customer_email"":null,""expires_at"":1696428172,""invoice"":null,""invoice_creation"":{{""enabled"":false,""invoice_data"":{{""account_tax_ids"":null,""custom_fields"":null,""description"":null,""footer"":null,""metadata"":{{}},""rendering_options"":null}}}},""line_items"":null,""livemode"":false,""locale"":null,""metadata"":{{}},""mode"":""payment"",""payment_intent"":null,""payment_link"":null,""payment_method_collection"":""if_required"",""payment_method_configuration_details"":null,""payment_method_options"":{{""acss_debit"":null,""affirm"":null,""afterpay_clearpay"":null,""alipay"":null,""au_becs_debit"":null,""bacs_debit"":null,""bancontact"":null,""boleto"":null,""card"":null,""cashapp"":null,""customer_balance"":null,""eps"":null,""fpx"":null,""giropay"":null,""grabpay"":null,""ideal"":null,""klarna"":null,""konbini"":null,""link"":null,""oxxo"":null,""p24"":null,""paynow"":null,""pix"":null,""sepa_debit"":null,""sofort"":null,""us_bank_account"":null}},""payment_method_types"":[""card""],""payment_status"":""paid"",""phone_number_collection"":{{""enabled"":false}},""recovered_from"":null,""setup_intent"":null,""shipping_address_collection"":null,""shipping_cost"":null,""shipping_details"":null,""shipping_options"":[],""status"":""open"",""submit_type"":null,""subscription"":null,""success_url"":""{successUrl}"",""tax_id_collection"":null,""total_details"":{{""amount_discount"":0,""amount_shipping"":0,""amount_tax"":0,""breakdown"":null}},""url"":""{portalUrl}""}}");

            result.Add($@"GET /v1/easymicroservices/successpayment HTTP/1.1
*RequestSkipBody*",
